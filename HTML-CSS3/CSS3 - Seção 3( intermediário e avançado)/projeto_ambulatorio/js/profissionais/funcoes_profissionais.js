...
function liberarCampo(){
	...
	document.getElementById('pesquisarNome').hidden = false
	document.getElementById('pesquisarNome').style.width ='45px'
	document.getElementById('pesquisarNome').style.height = '30px'
	document.getElementById('pesquisarNome').style.boxShadow = 'none'
	document.getElementById('pesquisarNome').style.cursor = 'pointer'
}
...
function esconderCampo(){
	...
	document.getElementById('pesquisarNome').hidden = true
}
